...
class TestChatAPI:
    ...
    async def test_chat_success(self, mock_create_agent, client):
    ...
    @patch("src.api.chat.create_agent")
    async def test_chat_with_session(self, mock_create_agent, client):
        mock_agent = MagicMock()
    ...
    @patch("src.api.chat.create_agent")
    async def test_chat_agent_error(self, mock_create_agent, client):
        mock_agent = MagicMock()
